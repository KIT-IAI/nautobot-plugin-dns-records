...
from nautobot_dns_records.api.views import AddressRecordViewSet, CNameRecordViewSet,TxtRecordViewSet, LocRecordViewSet, PtrRecordViewSet, SshfpRecordViewSet, SrvRecordViewSet
